  ...
  <body>
    <div class="container">
      ...
      <div class="table_header">
        <span class="table_title">PROVEEDORES</span>
        <div class="controls">
      ...
      <!-- =========================
             TABLA DE PROVEEDORES Y ESTADOS
             ========================= -->
      ...
      <div class="pagination">
        <div class="page-info">
          ...
          <span id="totalEntries">0</span> proveedores
        </div>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function () {
        ...
        window.borrarCapsula = function (id, nombre) {
          if (
            !confirm(
              `¿Estás seguro de que deseas borrar el proveedor "${nombre}" (ID: ${id})? Esta acción no se puede deshacer.`
            )
          ) {
            return;
          }
          ...
          fetch("../backend/borrar_proveedor.php", {
            method: "POST",
            headers: {
